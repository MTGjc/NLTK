...
print(pytesseract.image_to_string(Image.open('nltk0.png')))
...
#     src_vid = cv2.VideoCapture('Who_Am_I_JuntongZhou')
#     return(src_vid)
...
#         text = pytesseract.image_to_string(my_example, lang='en')
